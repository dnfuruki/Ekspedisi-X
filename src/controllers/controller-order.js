...
module.exports ={
    ...
    addDataOrder(req,res){
        let data = {id_user: req.body.nama_user, admin_id: req.body.nama_admin, id_ongkir: req.body.tujuan, nama_barang: req.body.nama_barang,  berat: req.body.berat, total_harga: req.body.berat * 10000, status: 'pengiriman' };
    ...
    editDataOrder(req,res){
        let sql = "UPDATE tabel_order SET id_order='"+req.body.id_order+"', id_user='"+req.body.nama_user+"',admin_id='"+req.body.nama_admin+"',id_ongkir='"+req.body.tujuan+"',nama_barang='"+req.body.nama_barang+"',berat='"+req.body.berat+"',total_harga='"+req.body.total_harga+"',status='"+req.body.status+"' WHERE id_order="+req.body.id_order;
         let query = pool.query(sql, (err, results) => {
          if(err) throw err;
          res.redirect('/order-cabang');
    });
